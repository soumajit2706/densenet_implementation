...
train_input_tensor = torch.load('./yelp_review_polarity_csv/train_input_tensor.pt')
train_label_tensor = torch.load('./yelp_review_polarity_csv/train_label_tensor.pt')
test_input_tensor = torch.load('./yelp_review_polarity_csv/test_input_tensor.pt')
test_label_tensor = torch.load('./yelp_review_polarity_csv/test_label_tensor.pt')
...
class Densenet(nn.Module):
    def __init__(self,input_size,growth_rate,do):
        ...
        self.fnn = nn.Linear(growth_rate,2)
